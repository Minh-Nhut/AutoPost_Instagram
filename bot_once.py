...
def _write_pw_worker():
    ...
    lines = [
        ...
        '\n',
        '        # ── Bước 3: Bấm "Tiếp" (Cắt → Lọc → Caption) ──\n',
        '        # Từ debug: nút "Tiếp" có aria-label="Tiếp", không có text\n',
        '        for step_name in ["Cắt→Lọc", "Lọc→Caption"]:\n',
        '            log(f"   ⏭️ Click Tiếp ({step_name})...")\n',
        '            next_clicked = False\n',
        '            # JS click: tìm button có aria="Tiếp" hoặc text="Tiếp"/"Next"\n',
        '            try:\n',
        '                clicked = page.evaluate("""\n',
        '                    () => {\n',
        ...
        '                """)\n',
        '                if clicked:\n',
        '                    log(f"   ✅ Click Tiếp JS: {clicked}")\n',
        '                    next_clicked = True\n',
        '            except Exception as e:\n',
        '                log(f"   ⚠️ JS Next lỗi: {e}")\n',
        '\n',
        '            if not next_clicked:\n',
        '                for sel in [\n',
        '                    \'[aria-label="Tiếp"]\',\n',
        ...
        '\n',
        '            if not next_clicked:\n',
        '                log(f"   ⚠️ Không tìm được Tiếp ở bước {step_name}")\n',
        '            time.sleep(random.uniform(2.0, 3.0))\n',
        '\n',
        ...
        '\n',
        '        # ── DEBUG: Dump buttons trước Share ──\n',
        '        try:\n',
        ...
        '\n',
        '        # ── Bước 5: Click Chia sẻ ──\n',
        '        # Từ debug: nút "Tiếp" cuối cùng là "Chia sẻ" (aria-label="Tiếp" đổi thành button submit)\n',
        '        posted = False\n',
        '        try:\n',
        '            clicked = page.evaluate("""\n',
        '                () => {\n',
        ...
        '                    return (targets[targets.length-1].getAttribute("aria-label") || targets[targets.length-1].innerText || "clicked");\n',
        '                }\n',
        '            """)\n',
        '            if clicked:\n',
        '                posted = True\n',
        ...
        '                    posted = True\n',
        '                    log(f"   🚀 Click Chia sẻ Playwright: {sel}")\n',
        '                    break\n',
        '                except Exception as e:\n',
        '                    log(f"      {sel}: lỗi {e}")\n',
        '\n',
