...
def _write_pw_worker():
    ...
    lines = [
        ...
        '                time.sleep(0.5)\n',
        '\n',
        '                # ── Ưu tiên 1: xclip paste (đáng tin cậy nhất với Lexical/React) ──\n',
        '                xclip_ok = False\n',
        '                try:\n',
        ...
        '                    el.click()\n',
        '                    time.sleep(0.3)\n',
        '                    # Xóa nội dung cũ rồi paste\n',
        '                    page.keyboard.press("Control+a")\n',
        '                    time.sleep(0.1)\n',
        '                    page.keyboard.press("Control+v")\n',
        '                    time.sleep(1.0)\n',
        '                    xclip_val = page.evaluate(f"""\n',
        '                        () => {{\n',
        '                            const el = document.querySelector(\'{sel}\');\n',
        '                            return el ? (el.innerText || el.value || el.textContent || "").trim() : "";\n',
        '                        }}\n',
        '                    """)\n',
        '                    log(f"   📌 xclip paste result: [{(xclip_val or \'\')[:60]}...]")\n',
        '                    if xclip_val and len(xclip_val.strip()) > 3:\n',
        '                        log(f"   ✅ Caption OK via xclip ({len(xclip_val)} ký tự)")\n',
        '                        caption_typed = True\n',
        '                        xclip_ok = True\n',
        '                        break\n',
        '                    else:\n',
        '                        log("   ⚠️ xclip paste không có text trong DOM, thử JS methods...")\n',
        '                except Exception as clip_e:\n',
        '                    log(f"   ⚠️ xclip lỗi: {clip_e}, thử JS methods...")\n',
        '\n',
        '                if xclip_ok:\n',
        '                    break\n',
        '\n',
        '                # ── Ưu tiên 2: JS methods (fallback) ──\n',
