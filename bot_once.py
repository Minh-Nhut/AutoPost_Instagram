...
def _write_pw_worker():
    ...
    lines = [
        ...
        '\n',
        '        caption_typed = False\n',
        '        # Dùng clipboard paste thay vì keyboard.type — hỗ trợ tiếng Việt có dấu\n',
        '        caption_sels = [\n',
        ...
        '                el.click()\n',
        '                time.sleep(0.5)\n',
        '                # Phương pháp 1: execCommand insertText — hoạt động tốt nhất với tiếng Việt\n',
        ...
        '                        // Chèn text mới (hỗ trợ Unicode/tiếng Việt)\n',
        '                        const ok = document.execCommand("insertText", false, {json.dumps(caption)});\n',
        '                        return ok;\n',
        '                    }}\n',
        '                """)\n',
        '                time.sleep(0.5)\n',
        ...
        '                    log(f"   ✅ Caption OK ({len(typed_val)} ký tự) via execCommand + {sel}")\n',
        '                    caption_typed = True\n',
        '                    break\n',
        '                else:\n',
        '                    # Phương pháp 2: clipboard paste qua xdotool/xclip\n',
        '                    try:\n',
        '                        import subprocess as sp\n',
        '                        # Ghi caption vào clipboard\n',
        ...
        '                            log(f"   ✅ Caption OK ({len(typed_val2)} ký tự) via clipboard + {sel}")\n',
        '                            caption_typed = True\n',
        '                            break\n',
        '                    except Exception as clip_e:\n',
        '                        log(f"   ⚠️ Clipboard paste lỗi: {clip_e}")\n',
        '            except Exception as e:\n',
        '                log(f"   ⚠️ Caption sel {sel}: {e}")\n',
        '\n',
        '        if not caption_typed:\n',
        '            # Fallback cuối: JS tìm bất kỳ contenteditable visible trong dialog\n',
        '            try:\n',
        '                result = page.evaluate(f"""\n',
        '                    () => {{\n',
        '                        // Ưu tiên tìm trong dialog tạo bài\n',
        '                        const scopes = [\n',
        ...
        '                            if (val.length > 3) return val.length;\n',
        '                        }}\n',
        '                        return 0;\n',
        '                    }}\n',
        '                """)\n',
        ...
        '\n',
        '        if not caption_typed:\n',
        '            log("   ⚠️ Không nhập được caption, đăng không có caption")\n',
        '\n',
        '        time.sleep(random.uniform(2.0, 3.0))\n',
