...
def _write_pw_worker():
    ...
    lines = [
        ...
        '            """Đọc text thực tế trong editor sau khi nhập"""\n',
        '            try:\n',
        ...
        '                time.sleep(0.5)\n',
        '\n',
        '                # ── Ưu tiên 1: CDP set clipboard rồi Ctrl+V ──\n',
        '                # Đây là cách duy nhất đáng tin cậy với Lexical editor (Instagram)\n',
        '                # trong headless Chromium — không cần xclip, không cần display\n',
        '                cdp_ok = False\n',
        '                try:\n',
        '                    import json as _json\n',
        '                    cdp = context.new_cdp_session(page)\n',
        '                    cdp.send("Browser.setDownloadBehavior", {"behavior": "default"})\n',
        '                    # Set clipboard qua CDP\n',
        '                    cdp.send("Browser.grantPermissions", {\n',
        '                        "permissions": ["clipboardReadWrite", "clipboardSanitizedWrite"]\n',
        '                    })\n',
        '                    # Viết vào clipboard qua JS với Permissions đã grant\n',
        '                    page.evaluate(f"""\n',
        '                        async () => {{\n',
        ...
        '                        break\n',
        '                    else:\n',
        '                        log("   ⚠️ CDP clipboard paste không thấy text, thử pyperclip...")\n',
        '                except Exception as cdp_e:\n',
        '                    log(f"   ⚠️ CDP clipboard lỗi: {cdp_e}")\n',
        '\n',
        '                if cdp_ok:\n',
        '                    break\n',
        '\n',
        '                # ── Ưu tiên 2: pyperclip (nếu cài) ──\n',
        '                pyper_ok = False\n',
        '                try:\n',
        '                    import pyperclip\n',
        ...
        '                    val = _verify_caption(page, sel)\n',
        '                    if val and len(val.strip()) > 3:\n',
        '                        log(f"   ✅ Caption OK via pyperclip ({len(val)} ký tự)")\n',
        '                        caption_typed = True\n',
        '                        pyper_ok = True\n',
        '                        break\n',
        '                except Exception as pe:\n',
        '                    log(f"   ⚠️ pyperclip lỗi: {pe}")\n',
        '\n',
        '                if pyper_ok:\n',
        '                    break\n',
        '\n',
        '                # ── Ưu tiên 3: page.keyboard.type() theo chunk ──\n',
        '                # Gõ thật từng ký tự — Lexical LUÔN nhận keyboard events\n',
        '                # Chậm nhưng đáng tin cậy 100%\n',
        '                try:\n',
        '                    el.click()\n',
        '                    page.keyboard.press("Control+a")\n',
        '                    page.keyboard.press("Delete")\n',
        '                    time.sleep(0.2)\n',
        '                    # Gõ theo chunk 100 ký tự, delay nhỏ giữa các chunk\n',
        '                    chunk_size = 100\n',
        ...
        '                        time.sleep(0.2)\n',
        '                        if ci % 5 == 4:\n',
        '                            time.sleep(0.3)  # nghỉ thêm mỗi 500 ký tự\n',
        '                    time.sleep(1.0)\n',
        '                    val = _verify_caption(page, sel)\n',
        ...
        '                        break\n',
        '                    else:\n',
        '                        log("   ⚠️ keyboard.type không có text, thử JS methods...")\n',
        ...
        '                    break\n',
        '\n',
        '                # ── Ưu tiên 4: JS methods (last resort) ──\n',
        '                res = try_set_caption(page, sel, caption)\n',
        '                time.sleep(0.5)\n',
        '                log(f"   📌 JS Method: {res.get(\'method\',\'?\')} | ok: {res.get(\'ok\')} | len: {res.get(\'len\',0)}")\n',
        '                val = _verify_caption(page, sel)\n',
        '                log(f"   📌 Caption DOM value: [{(val or \'\')[:80]}...]")\n',
        '                if val and len(val.strip()) > 3:\n',
        '                    log(f"   ✅ Caption set OK ({len(val)} ký tự) via JS {res.get(\'method\',\'?\')} + {sel}")\n',
        '                    caption_typed = True\n',
        '                    break\n',
        '            except Exception as e:\n',
