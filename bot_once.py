...
def _write_pw_worker():
    ...
    lines = [
        ...
        '                    el.focus();\n',
        '\n',
        '                    // === Phương pháp 1: React fiber setState (đáng tin cậy nhất) ===\n',
        '                    try {\n',
        '                        const fiberKey = Object.keys(el).find(k => k.startsWith("__reactFiber") || k.startsWith("__reactInternalInstance"));\n',
        '                        if (fiberKey) {\n',
        '                            let fiber = el[fiberKey];\n',
        '                            // Leo lên fiber tree tìm component có stateNode\n',
        ...
        '                    } catch(e) {}\n',
        '\n',
        '                    // === Phương pháp 3: execCommand insertText ===\n',
        '                    try {\n',
        '                        // Xóa nội dung\n',
        '                        document.execCommand("selectAll", false, null);\n',
        '                        document.execCommand("delete", false, null);\n',
        '                        // Insert text từng đoạn nhỏ để tránh giới hạn\n',
        '                        const chunks = captionText.match(/[\\s\\S]{1,100}/g) || [captionText];\n',
        '                        for (const chunk of chunks) {\n',
        '                            document.execCommand("insertText", false, chunk);\n',
        '                        }\n',
        '                        // Force React nhận bằng InputEvent\n',
        '                        const iv = new InputEvent("input", {bubbles: true, cancelable: true, inputType: "insertText"});\n',
        '                        el.dispatchEvent(iv);\n',
        '                        const val = (el.innerText || el.value || el.textContent || "").trim();\n',
        '                        return {ok: val.length > 3, method: "execCommand_chunks", len: val.length};\n',
        '                    } catch(e) {}\n',
        '\n',
        ...
        '                time.sleep(0.5)\n',
        '\n',
        '                res = try_set_caption(page, sel, caption)\n',
        '                time.sleep(0.5)\n',
        '                log(f"   📌 Method: {res.get(\'method\',\'?\')} | ok: {res.get(\'ok\')} | len: {res.get(\'len\',0)}")\n',
        '\n',
        '                # Đọc lại để xác nhận\n',
        ...
        '                    }}\n',
        '                """)\n',
        '                log(f"   📌 Caption DOM value: [{(typed_val or \'\')[:60]}...]")\n',
        '\n',
        '                if typed_val and len(typed_val.strip()) > 3:\n',
        '                    log(f"   ✅ Caption set OK ({len(typed_val)} ký tự) via {res.get(\'method\',\'?\')} + {sel}")\n',
        '                    caption_typed = True\n',
        '                    break\n',
        '                else:\n',
        '                    log(f"   ⚠️ Caption DOM trống sau {res.get(\'method\')}, thử clipboard paste...")\n',
        ...
        '                            }}\n',
        '                        """)\n',
        '                        log(f"   📌 Caption sau xclip: [{(typed_val2 or \'\')[:60]}...]")\n',
        '                        if typed_val2 and len(typed_val2.strip()) > 3:\n',
        '                            log(f"   ✅ Caption OK via xclip ({len(typed_val2)} ký tự)")\n',
        '                            caption_typed = True\n',
        '                            break\n',
        '                    except Exception as clip_e:\n',
        '                        log(f"   ⚠️ xclip lỗi: {clip_e}")\n',
        '            except Exception as e:\n',
